...
'<table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="m_5275377665128817231bodyTable" style="border-collapse:collapse;height:100%;margin:0;padding:0;width:100%;background-color:#e9eaec">
    ...
    <tr>
    <td style="color:#555555;padding-top:3px;padding-bottom:20px">'.$pass.'</td>
    </tr>
    </tbody>
    </table><span class="im">
...
// $mail->isSMTP();            
//Set SMTP host name                          
$mail->Host = "shujathali92@gmail.com";
//Set this to true if SMTP host requires authentication to send email
$mail->SMTPAuth = true;                          
//Provide username and password     
$mail->Username = "shujathali92@gmail.com";                 
$mail->Password = "shujath.92";                           
//If SMTP requires TLS encryption then set it
$mail->SMTPSecure = "ssl";                           
//Set TCP port to connect to 
$mail->Port = 465;                                   
$mail->From = "shujathali92@gmail.com";
//$mail->From = "mohanraj@mediapurple.com";
$mail->FromName = "shujath";

$mail->addAddress("shujathali92@gmail.com");
$mail->AddReplyTo("shujathali92@gmail.com", $name);
//Set CC address
